...
class KotlinWeeklyIssueDataFetcherTest {
    ...
    fun `kotlinWeeklyIssue(url) query returns expected kotlin weekly issue entries when operation succeeds`() {
        ...
        assertEquals(
            ...
            context.read("data.kotlinWeeklyIssue[0].summary"),
        )
        ...
        assertEquals(
            ...
            context.read("data.kotlinWeeklyIssue[0].group"),
        )
        ...
        assertEquals(
            ...
            context.read("data.kotlinWeeklyIssue[1].group"),
        )
        ...
        assertEquals(
            ...
            context.read("data.kotlinWeeklyIssue[2].summary"),
        )
        ...
        assertEquals(
            ...
            context.read("data.kotlinWeeklyIssue[2].group"),
        )
        ...
        assertEquals(
            ...
            context.read("data.kotlinWeeklyIssue[3].summary"),
        )
        ...
        assertEquals(
            ...
            context.read("data.kotlinWeeklyIssue[3].group"),
        )
        ...
        assertEquals(
            ...
            context.read("data.kotlinWeeklyIssue[4].summary"),
        )
        ...
        assertEquals(
            ...
            context.read("data.kotlinWeeklyIssue[4].group"),
        )
    }
}
